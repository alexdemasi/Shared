...
namespace Shared.Logging
{
    public static class Extensions
    {
            ...
            LoggerConfiguration loggerConfiguration, string environmentName)
        {
            ...
            foreach (var p in loggerOptions.ExcludePaths)
            {
                loggerConfiguration.Filter
                    .ByExcluding(Matching.WithProperty<string>("RequestPath", n => n.EndsWith(p)));
            }

            foreach (var p in loggerOptions.ExcludeProperties)
            {
                loggerConfiguration.Filter.ByExcluding(Matching.WithProperty(p));
            }
        ...
        public static ISharedBuilder AddCorrelationContextLogging(this ISharedBuilder builder)
        {
